...
```{r Plot}
plot(MT ~ Age, data=POTN, pch=16, cex=0.5, xlim=c(18,110), xlab= "Age", ylab="Feel Females are Better at Multi-tasking")
...
The trouble with the interpretation of $e^{b_0}$ is that it represents the feelings of newborns about females. I think their opinions are biased. 

The value of $e^{b_1+b_3} = e^{`r b[2]+b[4]`} \approx `r exp(b[2]+b[4])`$ shows that the odds of favoring females, given age, increases by a factor `r exp(b[2]+b[4])-1` for every 1 point change in Age. 
