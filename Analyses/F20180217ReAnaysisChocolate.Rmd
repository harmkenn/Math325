...
pander(table(mychoc$Location), caption = "Number of Chocolate Bars from each Country")
```
...
```{r}
boxplot(Rating~ Location, data=mychoc, ylab="Expert Rating", xlab="Countries that have the most Chocolate Bars", main="Expert Rating of Chocolate \nby Countries that have the most Chocolate Bars", col=c("blue","gold"))
...
* Canada appears to have the best chocolate Bars.
* The U.K. appears to have the worst chocolate Bars.
